  ...
  function update<K extends keyof Omit<CustomChart, "id">>(
    ...
    setForm((prev) => {
      ...
      if (key === "metric") {
        ...
        next.timeRange = value === "status_distribution" ? null : (prev.timeRange || "30d");
      }
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-6">
      ...
      <div className="bg-white rounded-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="px-7 py-6 flex flex-col gap-5">
          ...
          {/* ── Time Range (hidden for status_distribution) ── */}
          {!isDistribution ? (
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1.5">
                Time Range
            ...
            // Info box for status distribution
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex gap-3">
              <span className="text-lg">ℹ️</span>
              <div>
                <div className="font-semibold text-sm text-green-800">
                  No Time Range — Live Snapshot
                </div>
                <div className="text-xs text-green-700 mt-1">
                  Status Distribution always shows the current state right now.
          ...
          {/* ── Color Thresholds ── */}
          {isDistribution ? (
            // Pie/donut — just color pickers for each slice
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-2">
              ...
              <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    className="w-20 border border-slate-200 rounded-lg px-2 py-1.5 text-sm outline-none"
                  />
